...
use app\modules\cpanel\models\SearchCategoryCompany;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * CategoryCompanyController implements the CRUD actions for CategoryCompany model.
 */
class CategoryCompanyController extends Controller
{
    ...
    {
        $searchModel = new SearchCategoryCompany();
    ...
    {
        if (($model = CategoryCompany::findOne(['id' => $id])) !== null) {
            return $model;
        }
